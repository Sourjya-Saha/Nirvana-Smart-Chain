...
const TeamRow: React.FC<TeamRowProps> = ({ teamMembers, duration = 80 }) => (
      ...
      {[...new Array(2)].fill(0).map((_, index) => (
        <React.Fragment key={index}>
          {teamMembers.map((member, idx) => (
            <div
              key={idx}
              className="card inline-block mb-[15px] w-80 whitespace-normal align-top bg-white rounded-xl shadow-lg p-6"
            >
              ...
              <div className="text-center">
                ...
                <div className="text-blue-600 font-semibold mb-3 tracking-tight">{member.position}</div>
                <div className="text-gray-600 leading-relaxed min-h-20">{member.description}</div>
              </div>
            </div>
          ))}
        </React.Fragment>
        ...
        <div className="section-heading">
          ...
          <div className="max-w-[640px] mx-auto">
            ...
            <p className="text-center text-[22px] leading-[30px] tracking-tight text-[#010D3E] mt-5">
              Our dedicated team combines expertise in blockchain, healthcare, and technology to
